...
! OÏÈCAHÈE ÏAPAMETPOB ÏPOÃPAMMÛ METOÄA
    ...
    REAL(8),DIMENSION(4)::XA,HX,D1,D2,GR
    ! PAÇMEPHOCTÜ MACCÈBOB U1,SM = N+1
    REAL(8),DIMENSION(5)::U1
    INTEGER,DIMENSION(5)::SM
    ! PAÇMEPHOCTÜ MACCÈBOB YA,Y1,Y2 = M+1
    REAL(8),DIMENSION(8)::YA,Y1,Y2
    ! PAÇMEPHOCTÜ MACCÈBA ES = ( N+M+2,N+2 )
    REAL(8),DIMENSION(13,6)::ES
    ! PAÇMEPHOCTÜ MACCÈBA A1 = ( N+1,N+2 )
    REAL(8),DIMENSION(5,6)::A1
    ! PAÇMEPHOCTÜ MACCÈBA A2 = ( L+1,N+2 )
    REAL(8),DIMENSION(1,6)::A2
    ! PAÇMEPHOCTÜ MACCÈBOB Y11,SN = N+M+1
    REAL(8),DIMENSION(12)::Y11
    INTEGER,DIMENSION(12)::SN
    ! PAÇMEPHOCTÜ MACCÈBA IS = ( M+2 )
    INTEGER,DIMENSION(9)::IS
    EXTERNAL F,CGR,UNCONS
! 
    NF=0
    Q=20
...
! ÇAÄAHÈE ÏAPAMETPOB METOÄA
    ...
    PAR(4)=2.     ! HOMEP BEPCÈÈ METOÄA ( = 1 ÈËÈ 2 )
...
! ÂÛÇÎÂ ÌÅÒÎÄÀ
    CALL CP1(N,L,M,X,A,B,P,F,CGR,CGS,Y,PAR,Q,UNCONS)
END PROGRAM VCP1
